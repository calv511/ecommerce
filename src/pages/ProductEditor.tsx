...
const ProductEditor: React.FC = () => {
  ...
  return (
    <main className="page" style={{ maxWidth: 760 }}>
      ...
      <ProductForm product={productQuery.data} submitLabel={isEditing ? "Save changes" : "Create product"} submitting={saveMutation.isPending} onSubmit={(values) => saveMutation.mutate(values)} />
